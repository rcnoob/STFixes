...
public class Patch
{
    ...
    public Patch(string patchName, string modulePath, string signatureName, string bytesHex,
        GameDataManager gameDataManager, ILogger<STFixes> logger)
    {
    ...
    public void PerformPatch()
    {
        ...
        {
            _logger.LogError(
                "[STFixes][Patch][PerformPatch()][Patch={patchName}][Signature={signatureName}] Error: Address not found.",
        ...
        _logger.LogInformation("[STFixes][Patch][PerformPatch()][Patch={patchName}][Signature={signatureName}][OriginalBytes={originalBytes}]",
        ...
        _logger.LogInformation(
            "[STFixes][Patch][PerformPatch()][Patch={patchName}][Signature={signatureName}][PatchedBytes={bytes}] Successful",
    ...
    public void UndoPatch()
    {
        ...
        {
            _logger.LogError(
                "[STFixes][Patch][UndoPatch()][Patch={patchName}][Signature={signatureName}] Error: Address not found.",
                _patchName, _signatureName);
            return;
        }
        ...
        {
            _logger.LogError(
                "[STFixes][Patch][UndoPatch()][Patch={patchName}][Signature={signatureName}] Error: Original bytes are null.",
                _patchName, _signatureName);
            return;
        }
        ...
        _logger.LogInformation(
            "[STFixes][Patch][UndoPatch()][Patch={patchName}][Signature={signatureName}][OriginalBytes={originalBytes}] Successful",
            _patchName, _signatureName, Utils.ByteToHex(_originalBytes));
